...
func RegisterService() {
	...
	chat_pb.RegisterChatServer(gs, chatService)
	...
	zap.S().Info("开始注册服务中心....")
	if register.SrvRegister.Register(global.Config.ProjectName, global.Config.Uuid, args["host"].(string), args["port"].(int), global.Config.Consul.Tags, nil) {
		zap.S().Info("注册服务中心成功")
	}
}
